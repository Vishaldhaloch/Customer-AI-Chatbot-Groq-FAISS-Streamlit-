...
def record_and_transcribe():
    with st.spinner("\ud83c\udfa4 Listening... Speak now."):
        try:
            ...
            st.success("\u2705 Transcription done! Click 'Send' to submit.")
    ...
    if st.session_state.user_input:
        ...
        with st.spinner("Thinking..."):
            ...
            if audio_file and os.path.exists(audio_file):
                ...
                st.error("Audio file not found or failed to generate.")
...
def main():
    ...
    # st.image("E:/customer supprot chatbog/euron (1).jpg", width=200)
    st.title("Customer Support AI Chatbot")
    st.markdown("Ask questions about  products, services, or policies")
    ...
    with col2:
        ...
        if st.session_state.recording_state == "listening":
    ...
    with st.expander("How to use Customer Support AI Chatbot", expanded=False):
        st.markdown("""
        ### Instructions
